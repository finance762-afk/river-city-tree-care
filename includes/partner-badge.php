...
<div class="poi-partner-seal" style="text-align:center;padding:4px 16px 24px">
  <a href="https://pageonepartner.com/<?php echo $ppSlug; ?>/" target="_blank" rel="noopener" title="<?php echo $ppNameEsc; ?> on Page One Partner" style="display:inline-block;line-height:0;border-radius:14px">
